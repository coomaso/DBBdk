...
def calculate_daily_work_durations(processed_records):
    ...
    return daily_work_durations, daily_records
...
def check_new_records():
    ...
    try:
        ...
        if new_records:
            ...
            # 计算每日工作时长
            daily_work_durations, daily_records = calculate_daily_work_durations(processed_records)
